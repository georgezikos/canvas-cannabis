...
;// CONCATENATED MODULE: ./src/components/FrequentlyAskedQuestions/FrequentlyAskedQuestions.js
...
var $faqQuestionsParent = $('.faq__questions'); // houses all of the toggle buttons

var $toggleButton = $('.faq__question-container'); // container with question and toggle icon - triggers the whole thing

var $toggleIcon = $('.faq__toggle-icon'); // toggle icon needs to rotate

var $questionAnswer = $('.faq__question-answer'); // question and answer parent
// Classes

var activeToggleButton = 'faq__question-container--active';
var activeAnswer = 'faq__answer-container--active';
var activeToggleIcon = 'faq__toggle-icon--active'; // Other
...
var FrequentlyAskedQuestions = function FrequentlyAskedQuestions() {
  ...
  $toggleButton.on('click', function () {
    var $this = $(this);
    var $otherTabs = $this.parent().siblings($questionAnswer);
    ...
    if ($this.find($toggleIcon).hasClass(activeToggleIcon)) {
      ...
      gsapWithCSS.fromTo($this.find($toggleIcon), {
        duration: 0.25,
        rotation: 90
      }, {
        duration: 0.25,
  ...
  $toggleButton.on('keyup', function (e) {
    ...
    if (e.keyCode === enterKey) {
      var $this = $(this);
      var $otherTabs = $this.parent().siblings($questionAnswer); // $this.attr('tabindex', '-1');

      $this.attr('aria-selected', 'true'); // $otherTabs.find($toggleButton).attr('tabindex', '0');

      $otherTabs.find($toggleButton).attr('aria-selected', 'false');
      $this.toggleClass(activeToggleButton); // aria handling
      // if ($otherTabs.find($toggleButton).hasClass(activeToggleButton)) {
      //   $otherTabs.find($toggleButton).attr('aria-selected', 'false');
      // }

      $this.next().toggleClass(activeAnswer); // aria handling
  ...
  $faqQuestionsParent.on('keydown', function (e) {
    var moveRight = 39;
    var moveLeft = 37; // Enter only if left or right keys

    if (e.keyCode === moveRight || e.keyCode === moveLeft) {
      $questionAnswer[tabFocus].firstChild.setAttribute('tabindex', -1);
      $questionAnswer[tabFocus].firstChild.setAttribute('aria-selected', 'false'); // move right
      ...
      $questionAnswer[tabFocus].firstChild.setAttribute('aria-selected', 'true');
      $questionAnswer[tabFocus].firstChild.focus();
    }
  });
};

/* harmony default export */ const FrequentlyAskedQuestions_FrequentlyAskedQuestions = (FrequentlyAskedQuestions);
;// CONCATENATED MODULE: ./src/support.js
 // Imported into the Customer Support page head

var CustomerSupport = function CustomerSupport() {
  FrequentlyAskedQuestions_FrequentlyAskedQuestions();
};
