...
const validateAge = () => {
  if (!$verifyAge.prop('checked')) {
    ...
    // input type checkbox is invalid, target previous sibling .form__checkbox with styles
    const $onScreenCheckbox = $verifyAge.prev();
    $onScreenCheckbox.css('border-color', '#F3806D');
    return;
